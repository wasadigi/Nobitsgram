<%-- 
    Document   : myFollowings
    Created on : 9 janv. 2012, 15:44:05
    Author     : Eyram
--%>
...
<div class="bar2" id="positionbar">
    ...
    <div class="menubarre" id="position-menu-barre">
        ...
        <a href="<% out.print(root+ "/MyFollowingServlet"); %>"  class="is_selected" >My followings</a>
        <a href="<% out.print(root+ "/MyFollowerServlet"); %>">My followers</a>
       <a href="<% out.print(root+ "/MyFanServlet"); %>">My fans</a>
    </div>
        <% 
           List<UserInstagram> followings = (List<UserInstagram>)session.
             ...
             <tr>
                 ...
                 <td>
                  ...
                  <center id="buttonContainer">
                      <input type ="button" title ="UNFOLLOW" value="unfollow" name="<% out.print(userId); %>"  
