...
<div class="bar2" id="positionbar">
    ...
    <div class="menubarre" id="position-menu-barre">
       ...
       <a href="<% out.print(root+ "/MyFanServlet"); %>" class="is_selected">My fans</a>   
    </div>
        <% 
           List<UserInstagram> myFans = (List<UserInstagram>)session.
                                                getAttribute("myFans");
           ...
           if(myFans != null && !myFans.isEmpty()){
               size = myFans.size();
           }
           for(int i = 0; i < size; i++){
               userInsta = myFans.get(i);
