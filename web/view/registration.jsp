        ...
        <form action="/nobitsgram/RegistrationServlet" method="POST" accept-charset="utf-8">
            <table cellspacing="40" style="margin-left: 20%; background-color:#DCDCDC;">
                ...
                <tr>
                    ...
                    <td><input name="streetNumber" value="" size="8" type="text" /></td>
                </tr>

                <tr>
                    <td><label>Street address:</label></td>
                    <td><input name="street" value="" size="30" type="text" /></td>
                </tr>

                <tr>
                    <td><label>city:</label></td>
                    <td><input name="city" value="" size="30" type="text" /></td>
                </tr>

                <tr>
                    <td><label>ZIP/Postal Code:</label></td>
                    <td><input name="zip" value="" size="8" type="text" /></td>
                </tr>
