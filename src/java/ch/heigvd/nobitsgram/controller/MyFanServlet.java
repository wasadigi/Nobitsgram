...
@WebServlet(name = "MyFanServlet", urlPatterns = {"/MyFanServlet"})
public class MyFanServlet extends HttpServlet {
 ...
 protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
           ...
           // We get the list of Instagra user which the current user follow
            ...
            myFans = setListUrl(myFans, inter, access_token);

            session.setAttribute("myFans", myFans);

            sc.getRequestDispatcher("/view/myFans.jsp").
