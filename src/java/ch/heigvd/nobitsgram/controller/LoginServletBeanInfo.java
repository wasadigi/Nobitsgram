 ...
 * @author Eyram
 */
public class LoginServletBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( ch.heigvd.nobitsgram.controller.LoginServlet.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_initParameterNames] = new PropertyDescriptor ( "initParameterNames", ch.heigvd.nobitsgram.controller.LoginServlet.class, "getInitParameterNames", null ); // NOI18N
            properties[PROPERTY_servletConfig] = new PropertyDescriptor ( "servletConfig", ch.heigvd.nobitsgram.controller.LoginServlet.class, "getServletConfig", null ); // NOI18N
            properties[PROPERTY_servletContext] = new PropertyDescriptor ( "servletContext", ch.heigvd.nobitsgram.controller.LoginServlet.class, "getServletContext", null ); // NOI18N
            properties[PROPERTY_servletInfo] = new PropertyDescriptor ( "servletInfo", ch.heigvd.nobitsgram.controller.LoginServlet.class, "getServletInfo", null ); // NOI18N
            properties[PROPERTY_servletName] = new PropertyDescriptor ( "servletName", ch.heigvd.nobitsgram.controller.LoginServlet.class, "getServletName", null ); // NOI18N
        }
