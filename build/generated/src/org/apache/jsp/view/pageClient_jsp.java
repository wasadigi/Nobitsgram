...
public final class pageClient_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String url = "http://images.instagram.com/profiles/profile_13263821_75sq_1321367990.jpg"; 
      out.write("\n");
      out.write("        <h2 style=\"margin-left: 500px;\"> Bonjour ");
 out.println(username); 
      out.write(" </h2>\n");
      out.write("       <div style=\"width: 400px;height:300px; margin: 0 auto;background:#0AA9FF\">\n");
      out.write("\n");
      out.write("        <img src=\"http://images.instagram.com/profiles/profile_13263821_75sq_1321367990.jpg\"\n");
      out.write("             style=\"width: 400px; height: 300px\" >\n");
      out.write("\n");
      out.write("       </div>\n");
      out.write("         <p>  <span style=\"margin-left:467px;\">\n");
      out.write("                 <input type=\"submit\" value=\"Refresh\" class=\"button\"\n");
      ...
      out.write("\n");
      out.write("         </p>\n");
      out.write("          <table style=\" margin: 0 auto;width:400px;height: 60px;background: #DCDCDC\">\n");
      out.write("              <td> <label name=\"Topic\">Topic:</label>\n");
      out.write("             <input name=\"Topic\" size=\"30\" type=\"text\"/>\n");
      out.write("             <input type=\"submit\" value=\"Add Topic\" class=\"button\"\n");
      out.write("                        style=\"border:1px solid #f6b22b;\n");
      out.write("                        background:#fbe26eE;width:100px;\n");
      out.write("                        background-color:#F7D92E;\n");
      out.write("                        height: 35px;font-size:18px;\">\n");
